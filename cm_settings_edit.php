                                ...
                                <div class="ks-dashboard-tabbed-sidebar-widgets">
                                    ...
                                    <form action="" method="get">
                                        <div class="row" >
                                                ...
                                                <div class="col-sm-10">
                                                    <a href="<?php echo URL_BASEADMIN . $editpagename; ?>" class="btn btn-primary btn-sm float-right" title="ARCHIVES" >ARCHIVES</a>
                                                </div>
                                                <?php /* ?>
                                                <div class="col-sm-2">
                                                                ...
                                                                while ($row = mysqli_fetch_assoc($sel)) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center">
                                                                            ...
                                                                            <a class="btn btn-danger btn-sm" href="javascript:" onclick="return deletesure('<?php echo $row['id'];?>', '<?php echo $table; ?>', '');">Resole</a>
                                                                        </td>
                                                                    </tr>
                                                                    <?php
                                                                    $i++;
