...
if (($permission['add'] && !$_REQUEST['id']) || ($permission['edit'] && $_REQUEST['id'])) {
    ...
    <?php
    $pagename = "Net Weight";
    $listpagename = EMO_NET_WEIGHT_LIST;
    $table = TB_NET_WEIGHT;
    ...
    if ($_REQUEST['id']) {
        ...
        $supplier_min_weight = $data['supplier_min_weight'];
        $supplier_max_weight = $data['supplier_max_weight'];
        $yard_min_weight = $data['yard_min_weight'];
        $yard_max_weight = $data['yard_max_weight'];
        $status = $data['status'];
        ...
        $supplier_min_weight = $_REQUEST['supplier_min_weight'];
        $supplier_max_weight = $_REQUEST['supplier_max_weight'];
        $yard_min_weight = $_REQUEST['yard_min_weight'];
        $yard_max_weight = $_REQUEST['yard_max_weight'];
                                                ...
                                                <div class="card">                                                
                                                    <div class="card-block">
                                                        ...
                                                        <div> 
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="supplier_min_weight" class="col-sm-2 form-control-label">Supplier Min Weight</label>
                                                                <div class="col-sm-10">
                                                                    <div class="input-group">                         
                                                                        <input type="text" name="supplier_min_weight" id="supplier_min_weight" class="form-control" value="<?php echo $supplier_min_weight; ?>" > 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label for="supplier_max_weight" class="col-sm-2 form-control-label">Supplier Max Weight</label>
                                                                <div class="col-sm-10">
                                                                    <div class="input-group">                         
                                                                        <input type="text" name="supplier_max_weight" id="supplier_max_weight" class="form-control" value="<?php echo $supplier_max_weight; ?>" > 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label for="yard_min_weight" class="col-sm-2 form-control-label">Yard Min Weight</label>
                                                                <div class="col-sm-10">
                                                                    <div class="input-group">                         
                                                                        <input type="text" name="yard_min_weight" id="yard_min_weight" class="form-control" value="<?php echo $yard_min_weight; ?>" > 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label for="yard_max_weight" class="col-sm-2 form-control-label">Yard Max Weight</label>
                                                                <div class="col-sm-10">
                                                                    <div class="input-group">                         
                                                                        <input type="text" name="yard_max_weight" id="yard_max_weight" class="form-control" value="<?php echo $yard_max_weight; ?>" > 
                                                                    </div>
                                                                </div>
                                                            </div>
...
if (isset($_POST['addnew'])) {
     ...
     if ($_REQUEST['id']) {
        ...
        $arr = array(
            ...
            "supplier_min_weight"=>$_POST['supplier_min_weight'],
            "supplier_max_weight"=>$_POST['supplier_max_weight'],
            "yard_min_weight"=>$_POST['yard_min_weight'],
            "yard_max_weight"=>$_POST['yard_max_weight'],
            "status"=>$_POST['status'] 
        );            
