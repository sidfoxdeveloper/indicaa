...
if (($permission['add'] && !$_REQUEST['id']) || ($permission['edit'] && $_REQUEST['id'])) { ?>
    <?php
    $pagename = "Container";
    $editpagename = EMO_CONTAINER_TWO_EDIT.'?true&id='.$_REQUEST['id'];
    $listpagename = EMO_CONTAINER_THREE_EDIT.'?true&id='.$_REQUEST['id'];
    $back_page = EMO_CONTAINER_ONE_EDIT.'?true&id='.$_REQUEST['id'];
    $table = TB_CONTAINERS;
