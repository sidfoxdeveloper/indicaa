...
if ($permission['view']) { ?>
    ...
    $editpagename = EMO_NET_WEIGHT_EDIT;
    $table = TB_NET_WEIGHT;
                                                            ...
                                                            if (mysqli_num_rows($sel) > 0) {
                                                                ...
                                                                while ($row = mysqli_fetch_array($sel)) { ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $row['supplier_min_weight']; ?></td>
                                                                        <td><?php echo $row['supplier_max_weight']; ?></td>
                                                                        <td><?php echo $row['yard_min_weight']; ?></td>
                                                                        <td><?php echo $row['yard_max_weight']; ?></td>
                                                                        <td>
                                                                        <?php 
                                                                            $status = $row['status'];
