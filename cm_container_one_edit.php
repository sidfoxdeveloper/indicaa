...
if (($permission['add'] && !$_REQUEST['id']) || ($permission['edit'] && $_REQUEST['id'])) { ?>
    ...
    $listpagename = CM_CONTAINER_TWO_EDIT.'?true&id='.$_REQUEST['id'];
    $table = TB_CONTAINERS;
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div class="form-control dark" >
                                                                            <?php echo date( 'Y-m-d', strtotime($empty_container_received) ); ?>                                                                            
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <input type="text" name="empty_container_received" id="empty_container_received" value="" class="calendar form-control" placeholder="Select received date" > 
                                                                    </div>    
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div class="form-control dark" >
                                                                            <?php echo date( 'Y-m-d', strtotime($container_placed_yard) ); ?>                                                                            
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <input type="text" name="container_placed_yard" id="container_placed_yard" class="calendar form-control" placeholder="Select in yard date"> 
                                                                    </div>    
                                                                </div>
                                                        
                                                                <div class="form-group row">
                                                                    <label for="" class="col-sm-3 form-control-label">Name of the Yard &nbsp;(Loading Site):</label>
                                                                    <div class="col-sm-4">
                                                                        <div class="form-control dark" >
                                                                            <?php
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="container_size_id" class="col-sm-3 form-control-label">Container Size:</label>
                                                                    <div class="col-sm-4">
                                                                        <div class="form-control dark" >
                                                                            <?php 
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <input type="text" name="tare_weight" id="tare_weight" class="form-control" placeholder="Tare Weight" > 
                                                                    </div>   
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <input type="text" name="net_weight_supplier" id="net_weight_supplier" class="form-control" placeholder="Enter supplier net weight" >
                                                                    </div>   
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <input type="text" name="net_weight_yard" id="net_weight_yard" class="form-control" placeholder="Enter yard net weight" >
                                                                    </div>   
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <input type="text" name="pay_load" id="pay_load" class="form-control" placeholder="Enter total pay load   " >
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <textarea id="material_description" name="material_description" class="form-control" rows="3"></textarea>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <input type="text" name="material_quality_code" id="material_quality_code" class="form-control" placeholder="Material Quality Code" />
                                                                    </div>   
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <select name="seal_number" id="seal_number" class="form-control">
                                                                            ...
                                                                            <?php
                                                                            $seal = fetchqry('*', TB_SEAL_NUMBERS, array('id='=>'5') );
                                                                            $tmp = explode( ',', $seal['seal_number']);
                                                                            $i = 0;
                                                                            foreach ($tmp as $row):
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-6">
                                                                        <a class="btn btn-primary right" href="<?php echo URL_BASEADMIN . CM_CONTAINERS_LIST . $gobackurl; ?>">Back</a>
                                                                    </div>
                                                                    <div class="col-sm-6 text-right">
                                                                        <button class="btn btn-success right" type="button" onclick="return savennew(0);">
                                                                            Next 
                                                                        </button>
                                                                    </div>                                                                    
                                                                </div>
...
if (isset($_POST['addnew'])) {
    ...
    if ($_REQUEST['id']) {
        ...
        if( !isEmpty($_POST['empty_container_received']) ):
                $arr['empty_container_received'] = date( 'Y-m-d', strtotime($_POST['empty_container_received']) );   
        endif;
        if( !isEmpty($_POST['container_placed_yard']) ):
                $arr['container_placed_yard'] = date( 'Y-m-d', strtotime($_POST['container_placed_yard']) );
        endif;        
        ...
        if( !isEmpty($_POST['container_size_id']) ):
                $arr['container_size_id'] = $_POST['container_size_id'];
        endif;
        ...
        if( !isEmpty($_POST['seal_number']) ):
                $arr['seal_number'] = $_POST['seal_number'];
        endif;
