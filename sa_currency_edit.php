                                                ...
                                                <div class="card">                                                
                                                    <div class="card-block">
                                                        ...
                                                        <div>  
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="symbol" class="col-sm-2 form-control-label">Symbol</label>
                                                                <div class="col-sm-10">
                                                                    <div class="input-group">                         
                                                                        <input type="text" name="symbol" id="symbol" class="form-control" value="<?php echo $symbol; ?>" > 
                                                                    </div>
                                                                </div>
                                                            </div>
...
if (isset($_POST['addnew'])) {
     ...
     if ($_REQUEST['id']) {
        ...
        $arr = array( "name"=>$_POST['name'], "symbol"=>$_POST['symbol'], "country_id"=>$_POST['country_id'] );            
        $update = updateqry( $arr, array("id=" => $_REQUEST['id']), $table );        
        
    } else {
        
        $arr = array( "name"=>$_POST['name'], "symbol"=>$_POST['symbol'], "country_id"=>$_POST['country_id'], "created_at"=>date('Y-m-d h:i:s') );  
