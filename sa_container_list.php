...
if ($permission['view']) {
    ...
    $pagename = "Containers";
    $listpagename = SA_CONTAINER_LIST;
    $editpagename = SA_CONTAINER_EDIT;
    $viewpagename = SA_CONTAINER_VIEW;
    $table = TB_CONTAINERS;
                    ...
                    <div class="ks-page-header">
                        <section class="ks-title-and-subtitle">
                            <div class="ks-title-block">
                                    <h3 class="ks-main-title">View Containers</h3>
                            </div>
                            <div class="row">
                                                            ...
                                                            if (mysqli_num_rows($sel) > 0) {
                                                                ...
                                                                while ($row = mysqli_fetch_assoc($sel)) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <?php
                                                                            $sel_contries = fetchqry('*', TB_COUNTRIES, array('id='=>$row['country_id']));
