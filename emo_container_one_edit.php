                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <textarea id="material_description" name="material_description" class="form-control" rows="3" placeholder="Material Description"></textarea>
                                                                    </div>
                                                                </div>
...
if (isset($_POST['addnew'])) {
    ...
    if ($_REQUEST['id']) {
        ...
        if( !isEmpty($_POST['seal_number_id']) ):
                $arr['seal_number_id'] = $_POST['seal_number_id'];
        endif;
