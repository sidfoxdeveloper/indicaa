...
if (($permission['add'] && !$_REQUEST['id']) || ($permission['edit'] && $_REQUEST['id'])) {
    ...
    $pagename = "Container size";
    $listpagename = SA_CONTAINER_SIZE_LIST;
    $table = TB_CONTAINER_SIZE;
    ...
    if ($_REQUEST['id']) {
        ...
        $name = $_REQUEST['name'];
        $size_2 = $_REQUEST['size_2'];
        $size_3 = $_REQUEST['size_3'];
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <div class="input-group">                         
                                                                        <input type="text" name="name" id="name" class="form-control" value="<?php echo $name; ?>" autofocus > 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            
                                                            <div class="form-group row">
                                                                <label for="size_2" class="col-sm-2 form-control-label">Size 2</label>
                                                                <div class="col-sm-10">
                                                                    <div class="input-group">                         
                                                                        <input type="text" name="size_2" id="size_2" class="form-control" value="<?php echo $size_2; ?>" autofocus > 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label for="size_3" class="col-sm-2 form-control-label">Size 3</label>
                                                                <div class="col-sm-10">
                                                                    <div class="input-group">                         
                                                                        <input type="text" name="size_3" id="size_3" class="form-control" value="<?php echo $size_3; ?>" autofocus > 
                                                                    </div>
                                                                </div>
                                                            </div>
...
if (isset($_POST['addnew'])) {
     ...
     if ($_REQUEST['id']) {
        ...
        $arr = array( "name"=>$_POST['name'], "size_2"=>$_POST['size_2'], "size_3"=>$_POST['size_3'] );            
        $update = updateqry( $arr, array("id=" => $_REQUEST['id']), $table );        
        
    } else {
        
        $arr = array( "name"=>$_POST['name'], "size_2"=>$_POST['size_2'], "size_3"=>$_POST['size_3'], "created_at"=>date('Y-m-d h:i:s') );  
