...
<nav class="navbar ks-navbar">
    ...
    <div href="#" class="navbar-brand">
        ...
        <div class="ks-navbar-logo">
            ...
            <a href="dashboard.php" class="ks-logo"><img src="<?php echo URL_BASEADMIN;?>images/logo-white.png"></a>
            <!-- END GRID NAVIGATION -->
        </div>
    </div>
    <!-- END LOGO -->
                ...
                <div class="nav-item dropdown ks-user" id="dropdownToggle">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" >
                        <span class="ks-avatar">                            
                            <img src="<?php echo URL_BASEADMIN.'upload/1513241623.png' ?>" width="36" height="36">
                        </span>
                        <span class="ks-info">
