...
if (($permission['add'] && !$_REQUEST['id']) || ($permission['edit'] && $_REQUEST['id'])) { ?>
    <?php
    $pagename = "Container";
    $editpagename = EMO_CONTAINER_THREE_EDIT;
    $listpagename = EMO_CONTAINER_LIST;
    $back_page = EMO_CONTAINER_TWO_EDIT.'?id='.$_REQUEST['id'];
    $table = TB_CONTAINERS;
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="form-control dark" >
                                                                        <?php echo date( 'Y-m-d', strtotime($shipped_to_storage) ); ?>                                                                            
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="shipped_to_storage" id="shipped_to_storage" class="calendar form-control" placeholder="Date Shifted To Storage" > 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="storage" id="storage" class="form-control" placeholder="Enter Name Of Storage" > 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="form-control dark" >
                                                                        <?php echo date( 'Y-m-d', strtotime($shifted_to_terminal) ); ?>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="shifted_to_terminal" id="shifted_to_terminal" class="calendar form-control" placeholder="Date Shifted To Terminal" > 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="terminal" id="terminal" class="form-control" placeholder="Name of Terminal"> 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="form-control dark" >
                                                                        <?php echo date( 'Y-m-d', strtotime($shifted_to_port) ); ?>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="shifted_to_port" id="shifted_to_port" class="calendar form-control" placeholder="Date Shifted To Port" > 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="port_of_loading" id="port_of_loading" class="form-control" placeholder="Port Of Loading" > 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="grn_number" id="grn_number" class="form-control" placeholder="GRN Number"  > 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="form-control dark" >
                                                                        <?php echo date('Y-m-d', strtotime($grn_date) ); ?>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="grn_date" id="grn_date" class="calendar form-control" placeholder="GRN Date" > 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <select name="base_port_used_for_freight_costing" id="base_port_used_for_freight_costing" class="form-control">
                                                                        <option value="">Select Base Port For Freight Costing</option>
                                                                        <?php
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="ls_number" id="ls_number" class="form-control" placeholder="Enter LS Number" > 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="vo_number" id="vo_number" class="form-control" placeholder="Enter VO Number" > 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="voyage" id="voyage" class="form-control" placeholder="Enter Voyage" > 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="form-control dark" >
                                                                        <?php echo date('Y-m-d', strtotime($sob_date)); ?>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="sob_date" id="sob_date" class="calendar form-control" placeholder="Enter SOB Date" > 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="form-control dark" >
                                                                        <?php echo date('Y-m-d', strtotime($bli_date)); ?>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="bli_date" id="bli_date" class="calendar form-control" placeholder="Enter Bli Date" > 
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="bli_number" id="bli_number" class="form-control" placeholder="Enter BLI Number" >
                                                                </div>
                                                            </div>

                                                            <div class="form-group row">
                                                                <label for="original_bl_number" class="col-sm-3 form-control-label">Original B/L Number</label>
                                                                <div class="col-sm-4">
                                                                    <div class="form-control dark" >
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="original_bl_number" id="original_bl_number" class="form-control" placeholder="Original Bli Number" > 
                                                                </div>
                                                            </div>

                                                            <div class="form-group row">
                                                                <label for="ho_order_number" class="col-sm-3 form-control-label">H.O. Order Number</label>
                                                                <div class="col-sm-4">
                                                                    <div class="form-control dark" >
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="ho_order_number" id="ho_order_number" class="form-control" placeholder="Enter Ho Number" > 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <input type="text" name="ex_yard_price" id="ex_yard_price" class="form-control" placeholder="Ex Yard Price" > 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-6">
                                                                        <a class="btn btn-primary right" href="<?php echo URL_BASEADMIN . $back_page; ?>">Back</a>
                                                                    </div>
...
if (isset($_POST['addnew'])) {
    ...
    if ($_REQUEST['id']) {
        ...
        if( !isEmpty($_POST['shipped_to_storage']) ):
                $arr['shipped_to_storage'] = date('Y-m-d', strtotime($_POST['shipped_to_storage']) );
        endif;
        if( !isEmpty($_POST['storage']) ):
                $arr['storage'] = $_POST['storage'];
        endif;
        if( !isEmpty($_POST['shifted_to_terminal']) ):
                $arr['shifted_to_terminal'] = date('Y-m-d', strtotime($_POST['shifted_to_terminal']) );
        endif;
        if( !isEmpty($_POST['shipped_to_terminal']) ):
                $arr['shipped_to_terminal'] = date('Y-m-d', strtotime($_POST['shipped_to_terminal']) );
        endif;
        if( !isEmpty($_POST['terminal']) ):
                $arr['terminal'] = $_POST['terminal'];
        endif;
        if( !isEmpty($_POST['shifted_to_port']) ):
                $arr['shifted_to_port'] = date('Y-m-d', strtotime($_POST['shifted_to_port']) );
        endif;
        ...
        if( !isEmpty($_POST['grn_date']) ):
                $arr['grn_date'] = date('Y-m-d', strtotime($_POST['grn_date']) ); 
        endif;
        ...
        if( !isEmpty($_POST['bli_date']) ):
                $arr['bli_date'] = date('Y-m-d', strtotime($_POST['bli_date']) );
        endif;
        if( !isEmpty($_POST['bli_number']) ):
                $arr['bli_number'] = $_POST['bli_number'];
        endif;
        if( !isEmpty($_POST['sob_date']) ):
                $arr['sob_date'] = date('Y-m-d', strtotime($_POST['sob_date']) );
        endif;
