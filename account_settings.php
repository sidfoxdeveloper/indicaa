                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <div class="input-group">      
                                                                        <input type="text" id="email" name="email" value="<?php echo $email; ?>" disabled class="form-control" >
...
if (isset($_POST['addnew'])) {
     ...
     /** Check Unique Fields * */
       ...
       $arr = array("first_name" => $_POST['first_name'], "mname" => $mname, "last_name" => $_POST['last_name'], "email" => $_POST['email'], "password" => encode($_POST['password']), "address1" => $address1, "address2" => $address2, "locations_id" => $_POST['province'], "city" => $city, "postalcode" => $postalcode, "phone" => $_POST['phone'], "fax" => $_POST['fax']);
