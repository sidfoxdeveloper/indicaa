...
if ($permission['view']) {
    ...
    $totalContainers = $containersVerified = $containerNotVerified = $containersUnderLoading = 0;
    ...
    $qryUnder = "select `id` FROM `".$table."` WHERE `status`='draft' OR `status`='pending_upload' ";
                                            ...
                                            <div class="">
                                                <div class="card-block">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 col-xs-12">                          
                                                            <div class="box-div">
                                                                <h4>Containers Under Loading</h4>
