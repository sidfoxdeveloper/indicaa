...
if (($permission['add'] && !$_REQUEST['id']) || ($permission['edit'] && $_REQUEST['id'])) { ?>
    ...
    if( !isEmpty($_REQUEST['search_container_number']) ):
        $container = fetchqry( 'id', TB_CONTAINERS, array('container_number='=>$_REQUEST['search_container_number']) );
    ...
    if ($container_id) {
        ...
        $pagetype = "View";
        $data = fetchqry("*", $table, array("id=" => $container_id));
                                                    ...
                                                    <div class="card-block">
                                                        <div>
                                                            <div class="form-group row">
                                                                <label for="search_container_number" class="col-sm-3 form-control-label">Enter Container Number</label>
                                                                <div class="col-sm-3">
                                                                    <div class="input-group">
                                                                        <input type="text" name="search_container_number" id="search_container_number" class="form-control" placeholder="Search Container Number" value="<?php echo $_REQUEST['search_container_number'];?>" > 
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-2">
                                                                    <button type="submit" class="btn btn-primary" placeholder="Retrive" > RETRIEVE </button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card">                                                
                                                    <div class="card-block">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <div class="mydropzone_stock_pile mydropzone">
                                                                                <?php
                                                                                $selimages_stock_pile = selectqry( '*', TB_CONTAINER_IMAGES, array("container_id="=>$container_id, "image_status="=>"image_stock_pile") );
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <div class="mydropzone_empty_container mydropzone">
                                                                                <?php
                                                                                $sel_images_empty_container = selectqry( '*', TB_CONTAINER_IMAGES, array("container_id="=>$container_id, "image_status="=>"image_empty_container") );
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <div class="mydropzone_container_loading mydropzone">
                                                                                <?php
                                                                                $sel_images_container_loading = selectqry( '*', TB_CONTAINER_IMAGES, array("container_id="=>$container_id, "image_status="=>"image_container_loading") );
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <div class="mydropzone_container_seal mydropzone">
                                                                                <?php
                                                                                $sel_images_container_seal = selectqry( '*', TB_CONTAINER_IMAGES, array("container_id="=>$container_id, "image_status="=>"image_container_seal") );
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <div class="mydropzone_images_documents mydropzone">
                                                                                <?php
                                                                                $sel_images_documents = selectqry( '*', TB_CONTAINER_IMAGES, array("container_id="=>$container_id, "image_status="=>"image_documents") );
                                                        ...
                                                        <?php
                                                            ...
                                                            echo '<center><h3>Container not found</h3></center>';
                                                        endif;
                                                        ?>
