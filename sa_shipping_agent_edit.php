...
if (($permission['add'] && !$_REQUEST['id']) || ($permission['edit'] && $_REQUEST['id'])) {
    ?>
    <?php
    $pagename = "Shipping Agent";
    $listpagename = SA_SHIPPING_AGENT_LIST;
    $table = TB_SHIPPING_AGENT;
        ...
        <body class="customer-add-page invoice-list-page ks-navbar-fixed ks-sidebar-default ks-sidebar-position-fixed ks-page-header-fixed ks-theme-primary ks-page-loading"> 
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div>  
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="name" class="col-sm-2 form-control-label">SHIPPING AGENT <br>(Forwarder) </label>
                                                                <div class="col-sm-10">
            ...
            <script>
                function chkrequired() {
                    ...
                    chk['t:name'] = " Shipping Agent Name.";
