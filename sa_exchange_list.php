...
if ($permission['view']) {
    ...
    $pagename = "Cost";
    $listpagename = SA_COST_LIST;
    $editpagename = SA_COST_EDIT;
    $table = TB_COST;
                                                            ...
                                                            if (mysqli_num_rows($sel) > 0) {
                                                                ...
                                                                while ($row = mysqli_fetch_assoc($sel)) { ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <?php 
                                                                            $ex_yard = fetchqry( '*', TB_CURRENCY, array('id='=>$row['ex_yard_price_currency_id_1']) );
                                                                            echo $ex_yard['name'].'('.$ex_yard['symbol'].')';
                                                                            ?>
                                                                        </td>
                                                                        <td>
                                                                            <?php 
                                                                            $ex_yard = fetchqry( '*', TB_CURRENCY, array('id='=>$row['ex_yard_price_currency_id_2']) );
                                                                            echo $ex_yard['name'].'('.$ex_yard['symbol'].')';
                                                                            ?>
                                                                        </td>
                                                                        <td>
                                                                            <?php 
                                                                            $ex_yard = fetchqry( '*', TB_CURRENCY, array('id='=>$row['ex_yard_price_currency_id_3']) );
                                                                            echo $ex_yard['name'].'('.$ex_yard['symbol'].')';
                                                                            ?>
                                                                        </td>
                                                                        <td>
                                                                            <?php 
                                                                            $f_cost = fetchqry( '*', TB_CURRENCY, array('id='=>$row['fobing_cost_currency_id_1']) );
                                                                            echo $f_cost['name'].'('.$f_cost['symbol'].')';
                                                                            ?>
                                                                        </td>
                                                                        <td>
                                                                            <?php
                                                                            ...
                                                                            if($status == 'unverified'):    
                                                                                echo '<button class="btn btn-danger btn-sm" >Not verified</button>';
