...
if ($permission['view']) {
    ...
    if( !isEmpty($_REQUEST["export_data"]) && $_REQUEST["export_data"] == 'export_data' ) {
            ...
            echo $qry .= " LEFT JOIN `".TB_BASE_PORT_USED_FOR_FREIGHT_COSTING."` as bp ON bp.`id`=c.`base_port_used_for_freight_costing` ";
                                                                ...
                                                                while ($row = mysqli_fetch_assoc($sel)) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center">
                                                                            ...
                                                                            ?>
                                                                            <a href="<?php echo $archieveUrl; ?>" class="btn  <?php echo $archieveClass; ?>  btn-sm" title="<?php echo $archieveText; ?>" <?php if($archieveUrl == '#'){ echo 'onClick="isArchieved();"'; }?>  ><?php echo $archieveText; ?></a>                                                                            
                                                                        </td>
                                                                    </tr>
                                                                    <?php
                                                                    $i++;
